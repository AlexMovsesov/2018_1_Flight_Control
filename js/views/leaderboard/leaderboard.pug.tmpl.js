...
;pug_debug_line = 5;pug_debug_filename = "\u002FUsers\u002Falex\u002FWebstormProjects\u002Fflightcontrol\u002Fjs\u002Fviews\u002Fleaderboard\u002Fleaderboard.pug";
pug_html = pug_html + (pug.escape(null == (pug_interp = 'Leaderboard') ? "" : pug_interp)) + "\u003C\u002Fh1\u003E";
...
pug_html = pug_html + "\u003Cdiv class=\"js-scoreboard__paginator paginator\"\u003E\u003C\u002Fdiv\u003E\u003C\u002Fsection\u003E";} catch (err) {pug.rethrow(err, pug_debug_filename, pug_debug_line);};return pug_html;} export default template;