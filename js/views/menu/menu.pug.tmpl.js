export default function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;var pug_debug_filename, pug_debug_line;try {;var locals_for_with = (locals || {});(function (links) {;pug_debug_line = 1;pug_debug_filename = "\u002FUsers\u002Falex\u002FWebstormProjects\u002Fflightcontrol\u002Fjs\u002Fblocks\u002Fcommon\u002Fmixins.pug";
...
pug_html = pug_html + "\u003Ca" + (" class=\"menu_link\""+" href=\"#\""+pug_attr("data-route", link.route, true, false)) + "\u003E";
;pug_debug_line = 5;pug_debug_filename = "\u002FUsers\u002Falex\u002FWebstormProjects\u002Fflightcontrol\u002Fjs\u002Fblocks\u002Fcommon\u002Fmixins.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = link.name) ? "" : pug_interp)) + "\u003C\u002Fa\u003E\u003C\u002Fli\u003E";
};
...
pug_html = pug_html + "\u003C\u002Ful\u003E\u003C\u002Fsection\u003E";}.call(this,"links" in locals_for_with?locals_for_with.links:typeof links!=="undefined"?links:undefined));} catch (err) {pug_rethrow(err, pug_debug_filename, pug_debug_line);};return pug_html;}